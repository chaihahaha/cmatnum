...
int fm_11356(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_20_21, bmats.A_20_22, bmats.Ax3949, };
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_22_20.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_20_22.data[0][0], 1);
