...
inline int fm_160(double_cmat m, pack_mats_22x22 ABs) {
...
for (int i=0; i<BL; i++) {
    for (int j=0; j<BL; j++) {
        ...
        tmp1.data[i][j] = -ABs.B_1_5.data[i][j]-ABs.B_2_5.data[i][j]-ABs.B_3_5.data[i][j]-ABs.B_4_5.data[i][j]-ABs.B_5_5.data[i][j]-ABs.B_6_5.data[i][j]-ABs.B_7_5.data[i][j]-ABs.B_8_5.data[i][j]-ABs.B_9_5.data[i][j]-ABs.B_10_5.data[i][j]-ABs.B_11_5.data[i][j]+ABs.B_16_6.data[i][j]-ABs.B_6_12.data[i][j]-ABs.B_6_13.data[i][j]-ABs.B_6_14.data[i][j]-ABs.B_6_15.data[i][j]-ABs.B_6_16.data[i][j]-ABs.B_6_17.data[i][j]-ABs.B_6_18.data[i][j]-ABs.B_6_19.data[i][j]-ABs.B_6_20.data[i][j]-ABs.B_6_21.data[i][j]-ABs.B_6_22.data[i][j];
    }
}
