...
int fm_11812(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_20_19, bmats.A_20_20, bmats.Ax176, };
    double A_coeffs[3] = {-16, 1, 1, };
    int n_B_mats = 1;
    double_cmat B_mats[1] = {bmats.B_20_19, };
    double B_coeffs[1] = {1, };
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_20_19.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_19_20.data[0][0], 1);
