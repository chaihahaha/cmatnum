...
inline int fm_3575(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = bmats.A_7_12.data[i][j] + bmats.A_7_13.data[i][j] - 11*bmats.A_7_14.data[i][j] + bmats.A_7_15.data[i][j] + bmats.A_7_16.data[i][j] + bmats.A_7_17.data[i][j] + bmats.A_7_18.data[i][j] + bmats.A_7_19.data[i][j] + bmats.A_7_20.data[i][j] + bmats.A_7_21.data[i][j] + bmats.A_7_22.data[i][j];
            tmp0.data[i][j] *= dnum12;
            tmp1.data[i][j] = bmats.B_18_3.data[i][j];
        }
    }
