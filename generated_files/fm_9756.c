...
int fm_9756(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 7;
    double_cmat A_mats[7] = {bmats.A_18_19, bmats.A_18_20, bmats.A_19_19, bmats.A_19_20, bmats.Ax4351, bmats.Ax4354, bmats.Ax4495, };
    double A_coeffs[7] = {16, -1, 16, -1, -1, -1, -1, };
    int n_B_mats = 1;
    double_cmat B_mats[1] = {bmats.Bx13253, };
    double B_coeffs[1] = {1, };
