...
inline int fm_2963(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = bmats.A_9_1.data[i][j] - 11*bmats.A_9_10.data[i][j] + bmats.A_9_11.data[i][j] + bmats.A_9_2.data[i][j] + bmats.A_9_3.data[i][j] + bmats.A_9_4.data[i][j] + bmats.A_9_5.data[i][j] + bmats.A_9_6.data[i][j] + bmats.A_9_7.data[i][j] + bmats.A_9_8.data[i][j] + bmats.A_9_9.data[i][j];
    ...
    for (int i=0; i<BL; i++) {
        ...
        bmats.C_9_10.data[i][j]+=12 * m.data[i][j];
        ...
        bmats.C_10_9.data[i][j]+=2 * m.data[i][j];
