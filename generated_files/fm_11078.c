...
int fm_11078(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_20_7, bmats.A_20_8, bmats.Ax3405, };
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_24_4.data[0][0], 1);
