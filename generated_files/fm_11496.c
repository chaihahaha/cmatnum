...
inline int fm_11496(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_17_21, bmats.A_17_22, bmats.Ax3940, };
