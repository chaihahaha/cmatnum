...
inline int fm_10948(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_4_25, bmats.A_4_26, bmats.Ax2866, };
