...
inline int fm_10167(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_30_29, bmats.A_30_30, bmats.Ax1130, };
