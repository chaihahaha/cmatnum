...
inline int fm_10259(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_9_13, bmats.A_9_14, bmats.Ax1036, };
