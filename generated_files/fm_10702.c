...
inline int fm_10702(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_17_27, bmats.A_17_28, bmats.Ax15, };
