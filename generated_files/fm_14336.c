...
inline int fm_14336(double_cmat m, pack_mats_32x32 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = -2*bmats.A_29_17.data[i][j] - 2*bmats.A_29_18.data[i][j] - 2*bmats.A_29_19.data[i][j] - 2*bmats.A_29_20.data[i][j] - 2*bmats.A_29_21.data[i][j] - 2*bmats.A_29_22.data[i][j] - 2*bmats.A_29_23.data[i][j] - 2*bmats.A_29_24.data[i][j] - 2*bmats.A_29_25.data[i][j] - 2*bmats.A_29_26.data[i][j] - 2*bmats.A_29_27.data[i][j] - 2*bmats.A_29_28.data[i][j] + 15*bmats.A_29_29.data[i][j] + 15*bmats.A_29_30.data[i][j] - 2*bmats.A_29_31.data[i][j] - 2*bmats.A_29_32.data[i][j] + 16*bmats.A_30_29.data[i][j] - bmats.A_30_30.data[i][j] - bmats.Ax1130.data[i][j];
            tmp0.data[i][j] *= dnum17;
            tmp1.data[i][j] = bmats.B_29_29.data[i][j] + bmats.B_29_30.data[i][j] + bmats.B_30_29.data[i][j];
        }
    }
