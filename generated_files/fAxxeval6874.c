#include "stdafx.h"
#include "fAxxeval6874.h"

inline int fAxxeval6874(pack_mats_32x32 bmats) {
    int BL = bmats.A_1_1.shape[0];
    memset(&bmats.Axx657.data[0][0], 0, sizeof(bmats.Axx657.data[0][0])*BL*BL);
    int n_A_mats = 14;
    ...
    matlincomb_double_contiguous(bmats.Axx657, n_A_mats, (double_cmat*)A_mats, (double*)A_coeffs);
