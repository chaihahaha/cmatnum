...
inline int fm_2786(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            ...
            tmp1.data[i][j] = -bmats.B_14_1.data[i][j]-bmats.B_14_2.data[i][j]-bmats.B_14_3.data[i][j]-bmats.B_14_4.data[i][j]-bmats.B_14_5.data[i][j]-bmats.B_14_6.data[i][j]-bmats.B_14_7.data[i][j]-bmats.B_14_8.data[i][j]-bmats.B_14_9.data[i][j]-bmats.B_14_10.data[i][j]-bmats.B_14_11.data[i][j];
        }
    }
