...
inline int fm_10674(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_22_27, bmats.A_22_28, bmats.Ax45, };
