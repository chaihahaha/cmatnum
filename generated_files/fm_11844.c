...
int fm_11844(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_32_17, bmats.A_32_18, bmats.Ax4652, };
    double A_coeffs[3] = {1, -16, 1, };
    int n_B_mats = 1;
    double_cmat B_mats[1] = {bmats.B_32_18, };
    double B_coeffs[1] = {1, };
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_32_18.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_18_32.data[0][0], 1);
