...
int fm_11514(double_cmat m, pack_mats_32x32 bmats) {
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_11_5.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_5_11.data[0][0], 1);
