...
inline int fm_11255(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_29_21, bmats.A_29_22, bmats.Ax2083, };
