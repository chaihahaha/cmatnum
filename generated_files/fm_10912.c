...
inline int fm_10912(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_8_25, bmats.A_8_26, bmats.Ax2845, };
