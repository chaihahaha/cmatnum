...
inline int fm_11151(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_24_23, bmats.A_24_24, bmats.Ax115, };
