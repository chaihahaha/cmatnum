...
inline int fm_11584(double_cmat m, pack_mats_32x32 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = -16*bmats.A_19_21.data[i][j] + bmats.A_19_22.data[i][j] + bmats.Ax3946.data[i][j];
