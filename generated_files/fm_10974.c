...
inline int fm_10974(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_16_7, bmats.A_16_8, bmats.Ax3489, };
