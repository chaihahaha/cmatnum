...
inline int fm_10619(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_16_11, bmats.A_16_12, bmats.Ax2184, };
