...
inline int fm_11562(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_24_21, bmats.A_24_22, bmats.Ax110, };
