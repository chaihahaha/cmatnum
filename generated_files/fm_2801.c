...
inline int fm_2801(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = -bmats.A_18_1.data[i][j] - bmats.A_18_10.data[i][j] - bmats.A_18_11.data[i][j] - bmats.A_18_12.data[i][j] - bmats.A_18_13.data[i][j] - bmats.A_18_14.data[i][j] - bmats.A_18_15.data[i][j] - bmats.A_18_16.data[i][j] - bmats.A_18_17.data[i][j] - bmats.A_18_18.data[i][j] - bmats.A_18_19.data[i][j] - bmats.A_18_2.data[i][j] - bmats.A_18_20.data[i][j] - bmats.A_18_21.data[i][j] - bmats.A_18_22.data[i][j] - bmats.A_18_3.data[i][j] - bmats.A_18_4.data[i][j] - bmats.A_18_5.data[i][j] - bmats.A_18_6.data[i][j] - bmats.A_18_7.data[i][j] - bmats.A_18_8.data[i][j] - bmats.A_18_9.data[i][j];
            tmp0.data[i][j] *= dnum12;
            tmp1.data[i][j] = -bmats.B_18_12.data[i][j]-bmats.B_18_13.data[i][j]-bmats.B_18_14.data[i][j]-bmats.B_18_15.data[i][j]-bmats.B_18_16.data[i][j]-bmats.B_18_17.data[i][j]-bmats.B_18_18.data[i][j]-bmats.B_18_19.data[i][j]-bmats.B_18_20.data[i][j]-bmats.B_18_21.data[i][j]-bmats.B_18_22.data[i][j];
        }
    }
