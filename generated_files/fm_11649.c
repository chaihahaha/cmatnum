...
int fm_11649(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_12_19, bmats.A_12_20, bmats.Ax2486, };
    double A_coeffs[3] = {1, -16, 1, };
    int n_B_mats = 1;
    double_cmat B_mats[1] = {bmats.B_28_4, };
    double B_coeffs[1] = {1, };
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_20_28.data[0][0], 1);
