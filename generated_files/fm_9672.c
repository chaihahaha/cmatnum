...
inline int fm_9672(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 6;
    double_cmat A_mats[6] = {bmats.A_14_15, bmats.A_14_16, bmats.A_14_31, bmats.A_14_32, bmats.Ax392, bmats.Ax745, };
    double A_coeffs[6] = {-1, -1, -1, -1, -1, -1, };
    int n_B_mats = 3;
    double_cmat B_mats[3] = {bmats.B_14_12, bmats.Bx3105, bmats.Bx3115, };
