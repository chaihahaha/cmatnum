...
inline int fm_9672(double_cmat m, pack_mats_32x32 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = -bmats.A_14_15.data[i][j] - bmats.A_14_16.data[i][j] - bmats.A_14_31.data[i][j] - bmats.A_14_32.data[i][j] - bmats.Ax392.data[i][j] - bmats.Ax745.data[i][j];
            tmp0.data[i][j] *= dnum17;
            tmp1.data[i][j] = -bmats.B_14_12.data[i][j] - bmats.Bx3105.data[i][j] - bmats.Bx3115.data[i][j];
        }
    }
