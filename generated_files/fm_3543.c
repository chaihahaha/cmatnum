...
inline int fm_3543(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = -bmats.A_1_1.data[i][j] - bmats.A_1_10.data[i][j] - bmats.A_1_11.data[i][j] - bmats.A_1_2.data[i][j] - bmats.A_1_3.data[i][j] + 11*bmats.A_1_4.data[i][j] - bmats.A_1_5.data[i][j] - bmats.A_1_6.data[i][j] - bmats.A_1_7.data[i][j] - bmats.A_1_8.data[i][j] - bmats.A_1_9.data[i][j];
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
        bmats.C_1_15.data[i][j]+=12 * m.data[i][j];
