...
inline int fm_3926(double_cmat m, pack_mats_22x22 ABs) {
...
for (int i=0; i<BL; i++) {
    for (int j=0; j<BL; j++) {
        ...
        tmp1.data[i][j] = -ABs.B_19_1.data[i][j]-ABs.B_19_2.data[i][j]-ABs.B_19_3.data[i][j]-ABs.B_19_4.data[i][j]-ABs.B_19_5.data[i][j]-ABs.B_19_6.data[i][j]-ABs.B_19_7.data[i][j]-ABs.B_19_8.data[i][j]-ABs.B_19_9.data[i][j]-ABs.B_19_10.data[i][j]-ABs.B_19_11.data[i][j]+ABs.B_10_19.data[i][j]-ABs.B_12_21.data[i][j]-ABs.B_13_21.data[i][j]-ABs.B_14_21.data[i][j]-ABs.B_15_21.data[i][j]-ABs.B_16_21.data[i][j]-ABs.B_17_21.data[i][j]-ABs.B_18_21.data[i][j]-ABs.B_19_21.data[i][j]-ABs.B_20_21.data[i][j]-ABs.B_21_21.data[i][j]-ABs.B_22_21.data[i][j];
    }
}
