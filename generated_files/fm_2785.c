...
inline int fm_2785(double_cmat m, pack_mats_22x22 ABs) {
...
for (int i=0; i<BL; i++) {
    for (int j=0; j<BL; j++) {
        ...
        tmp1.data[i][j] = -ABs.B_14_12.data[i][j]-ABs.B_14_13.data[i][j]-ABs.B_14_14.data[i][j]-ABs.B_14_15.data[i][j]-ABs.B_14_16.data[i][j]-ABs.B_14_17.data[i][j]-ABs.B_14_18.data[i][j]-ABs.B_14_19.data[i][j]-ABs.B_14_20.data[i][j]-ABs.B_14_21.data[i][j]-ABs.B_14_22.data[i][j];
    }
}
