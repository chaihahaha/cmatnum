...
inline int fm_10979(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_32_23, bmats.A_32_24, bmats.Ax3384, };
    double A_coeffs[3] = {-1, 16, -1, };
    int n_B_mats = 1;
    double_cmat B_mats[1] = {bmats.B_16_24, };
    double B_coeffs[1] = {1, };
