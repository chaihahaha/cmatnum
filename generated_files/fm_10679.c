...
int fm_10679(double_cmat m, pack_mats_32x32 bmats) {
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_27_6.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, -1, &m.data[0][0], 1, &bmats.C_12_27.data[0][0], 1);
