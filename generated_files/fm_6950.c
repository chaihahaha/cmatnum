...
inline int fm_6950(double_cmat m, pack_mats_32x32 bmats) {
    ...
    cblas_daxpy(BL*BL, -1, &m.data[0][0], 1, &bmats.C_22_6.data[0][0], 1);    cblas_daxpy(BL*BL, 1, &m.data[0][0], 1, &bmats.C_7_22.data[0][0], 1);    cblas_daxpy(BL*BL, 1, &m.data[0][0], 1, &bmats.C_22_23.data[0][0], 1);    free_double_matrix(tmp0);
