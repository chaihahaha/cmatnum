...
int fm_9792(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 7;
    double_cmat A_mats[7] = {bmats.A_18_27, bmats.A_18_28, bmats.A_28_27, bmats.A_28_28, bmats.Ax2232, bmats.Ax23, bmats.Ax61, };
