...
inline int fm_9784(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 7;
    double_cmat A_mats[7] = {bmats.A_17_25, bmats.A_17_26, bmats.A_26_25, bmats.A_26_26, bmats.Ax239, bmats.Ax2963, bmats.Ax58, };
