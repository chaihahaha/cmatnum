...
inline int fm_3567(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = bmats.A_6_12.data[i][j] + bmats.A_6_13.data[i][j] - 11*bmats.A_6_14.data[i][j] + bmats.A_6_15.data[i][j] + bmats.A_6_16.data[i][j] + bmats.A_6_17.data[i][j] + bmats.A_6_18.data[i][j] + bmats.A_6_19.data[i][j] + bmats.A_6_20.data[i][j] + bmats.A_6_21.data[i][j] + bmats.A_6_22.data[i][j];
            tmp0.data[i][j] *= dnum12;
            tmp1.data[i][j] = bmats.B_17_3.data[i][j];
        }
    }
