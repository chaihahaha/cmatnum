...
int fm_11694(double_cmat m, pack_mats_32x32 bmats) {
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_20_19.data[0][0], 1);
    cblas_daxpy(BL*BL, 1, &m.data[0][0], 1, &bmats.C_17_20.data[0][0], 1);
    cblas_daxpy(BL*BL, 1, &m.data[0][0], 1, &bmats.C_18_20.data[0][0], 1);
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_19_20.data[0][0], 1);
