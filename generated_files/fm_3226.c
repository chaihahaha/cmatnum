...
inline int fm_3226(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = bmats.A_11_1.data[i][j] + bmats.A_11_10.data[i][j] + bmats.A_11_11.data[i][j] + bmats.A_11_2.data[i][j] + bmats.A_11_3.data[i][j] + bmats.A_11_4.data[i][j] + bmats.A_11_5.data[i][j] + bmats.A_11_6.data[i][j] - 11*bmats.A_11_7.data[i][j] + bmats.A_11_8.data[i][j] + bmats.A_11_9.data[i][j];
            tmp0.data[i][j] *= dnum12;
            tmp1.data[i][j] = bmats.B_11_7.data[i][j];
        }
    }
