...
inline int fm_13304(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_3_17, bmats.A_3_18, bmats.Ax4589, };
