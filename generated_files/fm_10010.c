...
inline int fm_10010(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_20_31, bmats.A_20_32, bmats.Ax633, };
