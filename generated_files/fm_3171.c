...
inline int fm_3171(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = bmats.A_13_1.data[i][j] + bmats.A_13_10.data[i][j] + bmats.A_13_11.data[i][j] + bmats.A_13_2.data[i][j] + bmats.A_13_3.data[i][j] + bmats.A_13_4.data[i][j] + bmats.A_13_5.data[i][j] + bmats.A_13_6.data[i][j] + bmats.A_13_7.data[i][j] - 11*bmats.A_13_8.data[i][j] + bmats.A_13_9.data[i][j];
    ...
    for (int i=0; i<BL; i++) {
        ...
        bmats.C_2_8.data[i][j]+=12 * m.data[i][j];
