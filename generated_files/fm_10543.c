...
inline int fm_10543(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 1;
    double_cmat A_mats[1] = {bmats.Axx2868, };
    double A_coeffs[1] = {1, };
    int n_B_mats = 1;
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_28_23.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_23_28.data[0][0], 1);
