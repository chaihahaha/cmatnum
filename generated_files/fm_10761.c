...
int fm_10761(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_31_10, bmats.A_31_9, bmats.Ax2804, };
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_26_15.data[0][0], 1);
