...
int fm_11488(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_32_21, bmats.A_32_22, bmats.Ax3934, };
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_32_21.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_21_32.data[0][0], 1);
