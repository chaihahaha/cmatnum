...
inline int fm_2818(double_cmat m, pack_mats_22x22 ABs) {
...
for (int i=0; i<BL; i++) {
    for (int j=0; j<BL; j++) {
        ...
        tmp1.data[i][j] = -ABs.B_22_1.data[i][j]-ABs.B_22_2.data[i][j]-ABs.B_22_3.data[i][j]-ABs.B_22_4.data[i][j]-ABs.B_22_5.data[i][j]-ABs.B_22_6.data[i][j]-ABs.B_22_7.data[i][j]-ABs.B_22_8.data[i][j]-ABs.B_22_9.data[i][j]-ABs.B_22_10.data[i][j]-ABs.B_22_11.data[i][j];
    }
}
