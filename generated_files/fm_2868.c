...
inline int fm_2868(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            ...
            tmp1.data[i][j] = -bmats.B_1_19.data[i][j]-bmats.B_2_19.data[i][j]-bmats.B_3_19.data[i][j]-bmats.B_4_19.data[i][j]-bmats.B_5_19.data[i][j]-bmats.B_6_19.data[i][j]-bmats.B_7_19.data[i][j]-bmats.B_8_19.data[i][j]-bmats.B_9_19.data[i][j]-bmats.B_10_19.data[i][j]-bmats.B_11_19.data[i][j]+bmats.B_12_19.data[i][j]+bmats.B_13_19.data[i][j]+bmats.B_14_19.data[i][j]+bmats.B_15_19.data[i][j]+bmats.B_16_19.data[i][j]+bmats.B_17_19.data[i][j]+bmats.B_18_19.data[i][j]+bmats.B_19_19.data[i][j]+bmats.B_20_19.data[i][j]+bmats.B_21_19.data[i][j]+bmats.B_22_19.data[i][j];
        }
    }
