...
inline int fm_11138(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_30_7, bmats.A_30_8, bmats.Ax1422, };
