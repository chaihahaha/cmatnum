...
inline int fm_10293(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_21_29, bmats.A_21_30, bmats.Ax1115, };
