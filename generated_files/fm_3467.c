...
inline int fm_3467(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = bmats.A_21_1.data[i][j] + bmats.A_21_10.data[i][j] + bmats.A_21_11.data[i][j] + bmats.A_21_2.data[i][j] + bmats.A_21_3.data[i][j] - 11*bmats.A_21_4.data[i][j] + bmats.A_21_5.data[i][j] + bmats.A_21_6.data[i][j] + bmats.A_21_7.data[i][j] + bmats.A_21_8.data[i][j] + bmats.A_21_9.data[i][j];
            tmp0.data[i][j] *= dnum12;
            tmp1.data[i][j] = bmats.B_10_15.data[i][j];
        }
    }
    ...
    for (int i=0; i<BL; i++) {
        ...
        bmats.C_10_4.data[i][j]+=12 * m.data[i][j];
