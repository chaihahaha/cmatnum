...
inline int fm_13224(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_29_17, bmats.A_29_18, bmats.Ax2131, };
