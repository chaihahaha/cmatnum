...
inline int fm_228(double_cmat m, pack_mats_22x22 ABs) {
...
for (int i=0; i<BL; i++) {
    for (int j=0; j<BL; j++) {
        ...
        tmp1.data[i][j] = -ABs.B_12_4.data[i][j]-ABs.B_13_4.data[i][j]-ABs.B_14_4.data[i][j]-ABs.B_15_4.data[i][j]-ABs.B_16_4.data[i][j]-ABs.B_17_4.data[i][j]-ABs.B_18_4.data[i][j]-ABs.B_19_4.data[i][j]-ABs.B_20_4.data[i][j]-ABs.B_21_4.data[i][j]-ABs.B_22_4.data[i][j]-ABs.B_7_12.data[i][j]-ABs.B_7_13.data[i][j]-ABs.B_7_14.data[i][j]-ABs.B_7_15.data[i][j]-ABs.B_7_16.data[i][j]-ABs.B_7_17.data[i][j]-ABs.B_7_18.data[i][j]+ABs.B_15_18.data[i][j]-ABs.B_7_19.data[i][j]-ABs.B_7_20.data[i][j]-ABs.B_7_21.data[i][j]-ABs.B_7_22.data[i][j];
    }
}
