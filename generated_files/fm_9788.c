...
inline int fm_9788(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 7;
    double_cmat A_mats[7] = {bmats.A_19_27, bmats.A_19_28, bmats.A_27_27, bmats.A_27_28, bmats.Ax2230, bmats.Ax2567, bmats.Ax28, };
    double A_coeffs[7] = {16, -1, 16, -1, -1, -1, -1, };
    int n_B_mats = 1;
    double_cmat B_mats[1] = {bmats.Bx13301, };
    double B_coeffs[1] = {1, };
