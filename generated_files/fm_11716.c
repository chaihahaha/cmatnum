...
inline int fm_11716(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_30_19, bmats.A_30_20, bmats.Ax1569, };
