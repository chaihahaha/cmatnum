...
inline int fm_11278(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_16_5, bmats.A_16_6, bmats.Ax3911, };
