...
inline int fm_9673(double_cmat m, pack_mats_32x32 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = -bmats.A_30_15.data[i][j] - bmats.A_30_16.data[i][j] - bmats.A_30_31.data[i][j] - bmats.A_30_32.data[i][j] - bmats.Ax604.data[i][j] - bmats.Ax676.data[i][j];
            tmp0.data[i][j] *= dnum17;
            tmp1.data[i][j] = -bmats.B_30_22.data[i][j] - bmats.Bx2480.data[i][j] - bmats.Bx2481.data[i][j];
        }
    }
