...
inline int fm_13196(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_16_1, bmats.A_16_2, bmats.Ax4644, };
