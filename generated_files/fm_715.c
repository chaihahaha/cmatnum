...
inline int fm_715(double_cmat m, pack_mats_32x32 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = bmats.A_11_10.data[i][j] - 16*bmats.A_11_9.data[i][j] - bmats.A_25_14.data[i][j] + bmats.Ax1532.data[i][j] + bmats.Ax2627.data[i][j] + bmats.Ax2677.data[i][j];
            tmp0.data[i][j] *= dnum17;
            tmp1.data[i][j] = -bmats.B_10_11.data[i][j] - bmats.B_11_11.data[i][j] - bmats.B_12_11.data[i][j] - bmats.B_13_11.data[i][j] - bmats.B_14_11.data[i][j] - bmats.B_15_11.data[i][j] - bmats.B_16_11.data[i][j] - bmats.B_1_11.data[i][j] + bmats.B_27_9.data[i][j] - bmats.B_2_11.data[i][j] - bmats.B_3_11.data[i][j] - bmats.B_4_11.data[i][j] - bmats.B_5_11.data[i][j] - bmats.B_6_11.data[i][j] - bmats.B_7_11.data[i][j] - bmats.B_8_11.data[i][j] - bmats.B_9_11.data[i][j] - bmats.B_9_17.data[i][j] - bmats.B_9_18.data[i][j] - bmats.B_9_19.data[i][j] - bmats.B_9_20.data[i][j] - bmats.B_9_21.data[i][j] - bmats.B_9_22.data[i][j] - bmats.B_9_23.data[i][j] - bmats.B_9_24.data[i][j] - bmats.B_9_25.data[i][j] - bmats.B_9_26.data[i][j] - bmats.B_9_27.data[i][j] - bmats.B_9_28.data[i][j] - bmats.B_9_29.data[i][j] - bmats.B_9_30.data[i][j] - bmats.B_9_31.data[i][j] - bmats.B_9_32.data[i][j];
        }
    }
