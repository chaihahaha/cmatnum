...
int fm_11804(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_19_19, bmats.A_19_20, bmats.Ax4354, };
    double A_coeffs[3] = {-16, 1, 1, };
    int n_B_mats = 1;
    double_cmat B_mats[1] = {bmats.B_19_19, };
    double B_coeffs[1] = {1, };
    ...
    cblas_daxpy(BL*BL, 10, &m.data[0][0], 1, &bmats.C_19_19.data[0][0], 1);
