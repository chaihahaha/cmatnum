...
int fm_9795(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 7;
    double_cmat A_mats[7] = {bmats.A_13_13, bmats.A_13_14, bmats.A_2_13, bmats.A_2_14, bmats.Ax1027, bmats.Ax1054, bmats.Ax1939, };
    double A_coeffs[7] = {16, -1, 16, -1, -1, -1, -1, };
    int n_B_mats = 1;
    double_cmat B_mats[1] = {bmats.Bx13310, };
    double B_coeffs[1] = {1, };
