...
inline int fm_3942(double_cmat m, pack_mats_22x22 ABs) {
...
for (int i=0; i<BL; i++) {
    for (int j=0; j<BL; j++) {
        ...
        tmp1.data[i][j] = -ABs.B_21_1.data[i][j]-ABs.B_21_2.data[i][j]-ABs.B_21_3.data[i][j]-ABs.B_21_4.data[i][j]-ABs.B_21_5.data[i][j]-ABs.B_21_6.data[i][j]-ABs.B_21_7.data[i][j]-ABs.B_21_8.data[i][j]-ABs.B_21_9.data[i][j]-ABs.B_21_10.data[i][j]-ABs.B_21_11.data[i][j]+ABs.B_10_21.data[i][j]-ABs.B_12_21.data[i][j]-ABs.B_13_21.data[i][j]-ABs.B_14_21.data[i][j]-ABs.B_15_21.data[i][j]-ABs.B_16_21.data[i][j]-ABs.B_17_21.data[i][j]-ABs.B_18_21.data[i][j]-ABs.B_19_21.data[i][j]-ABs.B_20_21.data[i][j]-ABs.B_21_21.data[i][j]-ABs.B_22_21.data[i][j];
    }
}
