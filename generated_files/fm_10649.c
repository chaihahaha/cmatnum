...
inline int fm_10649(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_11_27, bmats.A_11_28, bmats.Ax2291, };
    double A_coeffs[3] = {-16, 1, 1, };
    int n_B_mats = 1;
    double_cmat B_mats[1] = {bmats.B_27_11, };
    double B_coeffs[1] = {1, };
