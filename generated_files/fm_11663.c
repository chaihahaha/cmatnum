...
inline int fm_11663(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_6_19, bmats.A_6_20, bmats.Ax4099, };
