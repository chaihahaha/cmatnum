...
int fm_10812(double_cmat m, pack_mats_32x32 bmats) {
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_10_7.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_7_10.data[0][0], 1);
