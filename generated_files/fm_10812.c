...
inline int fm_10812(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_7_10, bmats.A_7_9, bmats.Ax2929, };
