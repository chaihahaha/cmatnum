...
inline int fm_7566(double_cmat m, pack_mats_32x32 bmats) {
    ...
    cblas_daxpy(BL*BL, -1, &m.data[0][0], 1, &bmats.C_17_6.data[0][0], 1);    cblas_daxpy(BL*BL, 1, &m.data[0][0], 1, &bmats.C_8_17.data[0][0], 1);    cblas_daxpy(BL*BL, 1, &m.data[0][0], 1, &bmats.C_22_24.data[0][0], 1);    free_double_matrix(tmp0);
