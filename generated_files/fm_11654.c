...
int fm_11654(double_cmat m, pack_mats_32x32 bmats) {
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_13_4.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_4_13.data[0][0], 1);
