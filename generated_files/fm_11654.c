...
inline int fm_11654(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_13_3, bmats.A_13_4, bmats.Ax2152, };
