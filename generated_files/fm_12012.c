...
inline int fm_12012(double_cmat m, pack_mats_32x32 bmats) {
    ...
    cblas_daxpy(BL*BL, -1, &m.data[0][0], 1, &bmats.C_32_5.data[0][0], 1);    cblas_daxpy(BL*BL, 1, &m.data[0][0], 1, &bmats.C_21_21.data[0][0], 1);    cblas_daxpy(BL*BL, 1, &m.data[0][0], 1, &bmats.C_5_32.data[0][0], 1);    free_double_matrix(tmp0);
