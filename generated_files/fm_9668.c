...
inline int fm_9668(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 6;
    double_cmat A_mats[6] = {bmats.A_13_15, bmats.A_13_16, bmats.A_13_31, bmats.A_13_32, bmats.Ax568, bmats.Ax760, };
    double A_coeffs[6] = {-1, -1, -1, -1, -1, -1, };
    int n_B_mats = 8;
    double_cmat B_mats[8] = {bmats.B_13_11, bmats.B_13_12, bmats.B_13_14, bmats.B_13_15, bmats.B_13_16, bmats.B_13_2, bmats.B_13_5, bmats.Bx4615, };
