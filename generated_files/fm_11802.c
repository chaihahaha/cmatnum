...
int fm_11802(double_cmat m, pack_mats_32x32 bmats) {
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_11_3.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_3_11.data[0][0], 1);
