...
inline int fm_9707(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 6;
    double_cmat A_mats[6] = {bmats.A_3_15, bmats.A_3_16, bmats.A_3_31, bmats.A_3_32, bmats.Ax585, bmats.Ax775, };
    double A_coeffs[6] = {-1, -1, -1, -1, -1, -1, };
    int n_B_mats = 1;
    double_cmat B_mats[1] = {bmats.Bx12636, };
    double B_coeffs[1] = {-1, };
