...
inline int fm_11583(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 1;
    double_cmat A_mats[1] = {bmats.Axx1919, };
    double A_coeffs[1] = {1, };
    int n_B_mats = 1;
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_5_3.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_3_5.data[0][0], 1);
