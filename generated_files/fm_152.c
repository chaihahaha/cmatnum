...
inline int fm_152(double_cmat m, pack_mats_22x22 ABs) {
...
for (int i=0; i<BL; i++) {
    for (int j=0; j<BL; j++) {
        ...
        tmp1.data[i][j] = -ABs.B_1_5.data[i][j]-ABs.B_2_5.data[i][j]-ABs.B_3_5.data[i][j]-ABs.B_4_5.data[i][j]-ABs.B_5_5.data[i][j]-ABs.B_6_5.data[i][j]-ABs.B_7_5.data[i][j]-ABs.B_8_5.data[i][j]-ABs.B_9_5.data[i][j]-ABs.B_10_5.data[i][j]-ABs.B_11_5.data[i][j]+ABs.B_16_5.data[i][j]-ABs.B_5_12.data[i][j]-ABs.B_5_13.data[i][j]-ABs.B_5_14.data[i][j]-ABs.B_5_15.data[i][j]-ABs.B_5_16.data[i][j]-ABs.B_5_17.data[i][j]-ABs.B_5_18.data[i][j]-ABs.B_5_19.data[i][j]-ABs.B_5_20.data[i][j]-ABs.B_5_21.data[i][j]-ABs.B_5_22.data[i][j];
    }
}
