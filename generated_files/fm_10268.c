...
int fm_10268(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_2_13, bmats.A_2_14, bmats.Ax1054, };
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_13_2.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_2_13.data[0][0], 1);
