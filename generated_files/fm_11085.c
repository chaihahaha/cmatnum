...
inline int fm_11085(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_21_23, bmats.A_21_24, bmats.Ax350, };
