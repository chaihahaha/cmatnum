...
inline int fm_10615(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_15_11, bmats.A_15_12, bmats.Ax2181, };
