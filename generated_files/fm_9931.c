...
inline int fm_9931(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_31_31, bmats.A_31_32, bmats.Ax664, };
