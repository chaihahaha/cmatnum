...
inline int fm_2803(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            ...
            tmp1.data[i][j] = -bmats.B_7_12.data[i][j]-bmats.B_7_13.data[i][j]-bmats.B_7_14.data[i][j]-bmats.B_7_15.data[i][j]-bmats.B_7_16.data[i][j]-bmats.B_7_17.data[i][j]-bmats.B_7_18.data[i][j]-bmats.B_7_19.data[i][j]-bmats.B_7_20.data[i][j]-bmats.B_7_21.data[i][j]-bmats.B_7_22.data[i][j];
        }
    }
