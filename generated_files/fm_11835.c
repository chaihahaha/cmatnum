...
int fm_11835(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_7_3, bmats.A_7_4, bmats.Ax3813, };
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_7_3.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_3_7.data[0][0], 1);
