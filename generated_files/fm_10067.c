...
int fm_10067(double_cmat m, pack_mats_32x32 bmats) {
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_30_27.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_27_30.data[0][0], 1);
