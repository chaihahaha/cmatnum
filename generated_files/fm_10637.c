...
inline int fm_10637(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_9_27, bmats.A_9_28, bmats.Ax2285, };
