...
inline int fm_9854(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_11_15, bmats.A_11_16, bmats.Ax562, };
