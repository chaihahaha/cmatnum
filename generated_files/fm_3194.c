...
inline int fm_3194(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = bmats.A_16_12.data[i][j] + bmats.A_16_13.data[i][j] + bmats.A_16_14.data[i][j] + bmats.A_16_15.data[i][j] + bmats.A_16_16.data[i][j] + bmats.A_16_17.data[i][j] + bmats.A_16_18.data[i][j] - 11*bmats.A_16_19.data[i][j] + bmats.A_16_20.data[i][j] + bmats.A_16_21.data[i][j] + bmats.A_16_22.data[i][j];
    ...
    for (int i=0; i<BL; i++) {
        ...
        bmats.C_16_19.data[i][j]+=12 * m.data[i][j];
        ...
        bmats.C_19_16.data[i][j]+=2 * m.data[i][j];
