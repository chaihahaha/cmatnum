...
inline int fm_11728(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 1;
    double_cmat A_mats[1] = {bmats.Axx902, };
    double A_coeffs[1] = {1, };
    int n_B_mats = 1;
    double_cmat B_mats[1] = {bmats.B_32_19, };
    double B_coeffs[1] = {1, };
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_32_19.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_19_32.data[0][0], 1);
