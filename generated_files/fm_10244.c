...
int fm_10244(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_23_29, bmats.A_23_30, bmats.Ax1094, };
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_29_23.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_23_29.data[0][0], 1);
