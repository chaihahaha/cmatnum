...
inline int fm_3613(double_cmat m, pack_mats_22x22 bmats) {
    ...
    for (int i=0; i<BL; i++) {
        for (int j=0; j<BL; j++) {
            tmp0.data[i][j] = bmats.A_3_1.data[i][j] + bmats.A_3_10.data[i][j] + bmats.A_3_11.data[i][j] + bmats.A_3_2.data[i][j] - 11*bmats.A_3_3.data[i][j] + bmats.A_3_4.data[i][j] + bmats.A_3_5.data[i][j] + bmats.A_3_6.data[i][j] + bmats.A_3_7.data[i][j] + bmats.A_3_8.data[i][j] + bmats.A_3_9.data[i][j];
    ...
    for (int i=0; i<BL; i++) {
        ...
        bmats.C_3_3.data[i][j]+=5 * m.data[i][j];
