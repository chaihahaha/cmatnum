...
int fm_11339(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_2_5, bmats.A_2_6, bmats.Ax3920, };
    ...
    cblas_daxpy(BL*BL, 17, &m.data[0][0], 1, &bmats.C_6_2.data[0][0], 1);
    ...
    cblas_daxpy(BL*BL, 2, &m.data[0][0], 1, &bmats.C_2_6.data[0][0], 1);
