...
inline int fm_9935(double_cmat m, pack_mats_32x32 bmats) {
    ...
    int n_A_mats = 3;
    double_cmat A_mats[3] = {bmats.A_32_31, bmats.A_32_32, bmats.Ax533, };
